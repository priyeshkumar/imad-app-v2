...
var config = {
    user : 'priyeshkumar',
    database : 'priyeshkumar',
    host : 'db.imad.hasura-app.io',
    port: '5432',
    password : 'process.env.db-priyeshkumar-20836'
};
...
var articles= {
 'article-one': {
    title: 'Article One | Priyesh kumar',
    heading: 'Article One',
    date: 'feb 14, 2017',
    content:`<p>
  ...
  'article-two': { 
    title: 'Article Two | Priyesh kumar',
    heading: 'Article Two',
    date: 'feb 14, 2017',
    content:`<p>
  ...
  'article-three': {
    title: 'Article Three | Priyesh kumar',
